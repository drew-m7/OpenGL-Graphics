...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Solar System Scene 1", NULL, NULL);
    if (window == NULL)
    {
    ...
    // -------------------------
    Shader skyboxShader("../../src/shader/exp01/6.1.skybox.vert", "../../src/shader/exp01/6.1.skybox.frag");
    Shader planetShader("../../src/shader/exp01/6.1.planet.vert", "../../src/shader/exp01/6.1.planet.frag");
    Shader sunShader("../../src/shader/exp01/6.1.planet2.vert", "../../src/shader/exp01/6.1.planet2.frag");
    Shader planetShader2("../../src/shader/exp01/6.1.planet.vert", "../../src/shader/exp01/6.1.planet.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        planetShader2.setVec3("light.diffuse", 0.8f, 0.8f, 0.8f);
